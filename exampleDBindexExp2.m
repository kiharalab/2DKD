...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% exampleDBindexExp2.m -- This file is part of 2DKD.
% 
% In this example, we show how to index one of the databases in Experiment II.
% We index one .jpg image in the folder /Exp2/DB/. The result is stored in a
% matrix with rows of the form <Image number,xp,yp,V>, where (xp,yp) is the
% center of local region-of-interest and V the vector of 2DKD's at that
